...
public class WeddingDbContext : IdentityDbContext<ApplicationUser, IdentityRole<int>, int>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ===== ApplicationUser → ServiceProvider (1-to-1) =====
        modelBuilder.Entity<ServiceProvider>()
            .HasOne(s => s.User)
            .WithOne(u => u.ServiceProvider)
            .HasForeignKey<ServiceProvider>(s => s.UserId)
            .OnDelete(DeleteBehavior.Cascade);
        ...
        // ===== ServiceProviderMedia → ServiceProvider =====
        ...
        modelBuilder.Entity<ServiceProvider>()
            .Property(s => s.PriceFrom).HasPrecision(18, 2);
